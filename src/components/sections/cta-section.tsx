        ...
        <ScrollReveal>
          <div className="flex flex-col items-center justify-center space-y-6 text-center">
            <div className="space-y-4">
              <AnimatedText
                text="Готовы обсудить ваш объект?"
                variant="heading"
                className="text-3xl font-heading font-bold tracking-tighter sm:text-5xl gradient-text"
                animation="wave"
              />
              <AnimatedText
                text="Оставьте заявку — специалист свяжется в течение 2 часов, выедет на замер бесплатно и подготовит смету за 3 дня."
                variant="paragraph"
